...
class ConfirmForgetPaswordDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { token: { required: true, type: () => String, format: "uuid" }, newPassword: { required: true, type: () => String, minLength: 6 }, repeatPassword: { required: true, type: () => String, minLength: 6 } };
    }
}
...
//# sourceMappingURL=confirm-forget-password.dto.js.map