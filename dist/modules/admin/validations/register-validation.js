...
class RegisterAdminDto {
    ...
    email;
    password;
    role = admin_enum_1.AdminRole.ADMIN;
}
...
], RegisterAdminDto.prototype, "admin", void 0);
__decorate([
    (0, class_transformer_1.Type)(),
    (0, swagger_1.ApiProperty)(),
    (0, class_validator_1.MinLength)(3),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], RegisterAdminDto.prototype, "adminname", void 0);
__decorate([
    (0, class_transformer_1.Type)(),
    (0, swagger_1.ApiProperty)(),
    (0, class_validator_1.MinLength)(3),
...
__decorate([
    ...
    (0, swagger_1.ApiProperty)({ enum: admin_enum_1.AdminRole, default: admin_enum_1.AdminRole.ADMIN, required: false }),
