...
let UploadEntity = class UploadEntity extends typeorm_1.BaseEntity {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, imageUrl: { required: true, type: () => String }, songUrl: { required: true, type: () => String }, user: { required: true, type: () => require("./user.entity").UserEntity }, type: { required: true, type: () => Object }, createdAt: { required: true, type: () => Date }, updatedAt: { required: true, type: () => Date } };
    }
};
...
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], UploadEntity.prototype, "imageUrl", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], UploadEntity.prototype, "songUrl", void 0);
__decorate([
    (0, typeorm_1.OneToOne)(() => user_entity_1.UserEntity, (user) => user.upload),
